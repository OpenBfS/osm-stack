<?php
@define('CONST_BasePath', '/nominatim');
@define('CONST_InstallPath', '/nominatim/build');
...
@define('CONST_Database_DSN', 'pgsql:dbname=nominatim;host=nominatim-postgres-master;user=nominatim'); // or add ;host=...;port=...;user=...;password=...
// Setting Web_User to nominatim avoids to create this user in the database.
