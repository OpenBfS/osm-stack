...
@motorway-low-zoom-casing: #717171;
@trunk-low-zoom-casing: #828282;
@primary-low-zoom-casing: #8e8e8e;
@secondary-low-zoom-casing: darken(#e0e0e0,40%);

@motorway-casing: #646464;
@trunk-casing: #6e6e6e;
@primary-casing: #6e6e6e;
@secondary-casing: darken(#e0e0e0,40%);

@motorway-low-zoom: #949494;
@trunk-low-zoom: #aeaeae;
@primary-low-zoom: #c9c9c9;
@secondary-low-zoom: darken(#e0e0e0,20%);

@motorway-fill: #dbdbdb; // #adadad;
@trunk-fill: #dbdbdb; // #c4c4c4;
@primary-fill: #cbcbcb;
@secondary-fill: lighten(#e0e0e0,10%);


@motorway-shield: #252525;
@trunk-shield: #2b2b2b;
@primary-shield: #313131;
@secondary-shield: #313131;
...
@track-fill: @residential-fill;			// #696969;
...
@access-marking-living-street: #c9c9c9;

@default-casing: white;
@tertiary-casing: #8e8e8e;
...
@destination-marking: #dadada;
@private-marking: #bdbdbd;
@private-marking-for-red: #7e7e7e;
...
#roads-casing, #bridges, #tunnels {
  ...
  ::bridges_and_tunnels_background {
    ...
    [feature = 'railway_rail'][zoom >= 15],
    [feature = 'railway_preserved'][zoom >= 15],
    [feature = 'railway_monorail'][zoom >= 15] {
      #bridges {
        line-width: 5;
        line-color: white;
        line-join: round;
    ...
    [feature = 'railway_miniature'][zoom >= 15],
    [feature = 'railway_INT-preserved-ssy'][zoom >= 15] {
      #bridges {
        [zoom >= 15] {
          line-width: 4.5;
          line-color: white;
    ...
    [feature = 'highway_path']{
      ...
      [zoom >= 15] {
        #roads-fill[zoom >= 15] {
          ...
          background/line-cap: round;
          background/line-join: round;
          background/line-width: 0; // @bridleway-width-z15 + 2 * @paths-background-width;
          background/line-opacity: 0.4;
        }
